...
$$ \gamma U_s = RI_d + C_e \Phi n $$

导出机械特性为

$$ n = \frac{\gamma U_s}{C_e \Phi} - \frac{RI_d}{C_e \Phi} $$

其中电机平均电压又是由PWM控制器的输入电压$$U_c$$控制的，差了个系数有$$ \gamma U_s = K_s U_c $$。电枢电流和电磁转矩也是差个系数的关系$$ T_e = C_T \Phi I_d $$，整理一下就有了转速和转矩的关系

$$ n = \frac{K_c U_s}{C_e \Phi} - \frac{R}{C_e C_T \Phi^2}T_e = n_0 - KT_e $$
